...
const ROSC = () => {
  ...
  const [selectedOscillatorTypes, setSelectedOscillatorTypes] = useState({
    x: "sine",
    y: "sine",
  });
  const [selectedTuningRatioOption, setSelectedTuningRatioOption] = useState(
    allTuningRatioOptions[0],
  );
    ...
    <BaseAnimationPage title="Return of Spontaneous Circulation">
      ...
      <ROSC.ControlsPanel $isExposed={areControlsExposed}>
        ...
        <ROSC.ControlsContent $isExposed={areControlsExposed}>
          ...
          <ROSC.ControlPanelSection>
            <ROSC.Button id="saveButton" ref={saveButton}>
              Save Snapshot
            </ROSC.Button>
          </ROSC.ControlPanelSection>
          <ROSC.ControlPanelSection>
            ...
            <ROSC.ButtonGrid>
              {allOscillatorTypes.map((type) => (
                <ROSC.Button
                  ...
                  value={type}
                  disabled={
                    !drawingModeSupport[selectedDrawingMode].includes(type)
                  }
                >
                  {type}
                </ROSC.Button>
